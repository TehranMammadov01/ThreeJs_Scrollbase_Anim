...
const titleElements = document.getElementsByTagName('section');
titleElements[currentSection].children[0].classList.add('title-animation');
...
window.addEventListener('scroll', () => {
    ...
    if(newSection !== currentSection) {
        ...
        titleElements[previousSection].children[0].classList.remove('title-animation');
        titleElements[currentSection].children[0].classList.add('title-animation');
